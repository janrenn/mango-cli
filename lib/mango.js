...
Mango.prototype._task = function(name, gulp) {
	var fn = TASKS[name](gulp, this.config)
...
Mango.prototype._registerGulpTasks = function(gulp, whitelist, blacklist) {
	...
	gulp.task('watch:reload', TASKS['watch_reload'](gulp, this.config, watcher))
	gulp.task('watch:sources', TASKS['watch_sources'](gulp, this.config, watcher))
